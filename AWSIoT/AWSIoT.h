...
/*!
 Project version number for the AWSIoT framework.
 ...
 patch-level versioning, you should use AWSIoTSDKVersion instead.
 @deprecated Use AWSIoTSDKVersion instead.
 */
FOUNDATION_EXPORT double AWSIoTVersionNumber DEPRECATED_MSG_ATTRIBUTE("Use AWSIoTSDKVersion instead.");

/*!
 Project version string for the AWSIoT framework.
